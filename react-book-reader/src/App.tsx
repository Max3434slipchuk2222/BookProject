        ...
        <main className="main-content">
          {currentView === 'library' && (
              <div className="library-view">
                {/* Книги з Spring Boot сервера (RTK Query) */}
                <BookList onOpenBook={openBook} />

                {/* Локальна бібліотека (localStorage) */}
                {books.length > 0 && (
                    <>
                      <h2 style={{ marginTop: '2rem', marginBottom: '1rem', fontFamily: 'Crimson Pro, serif', fontSize: '24px' }}>
                        My Books
                      </h2>
                ...
                {/* Empty state — тільки якщо немає ні серверних ні локальних книг */}
                {books.length === 0 && (
                    <div className="empty-state" style={{ marginTop: '2rem' }}>
                      <h2>No local books yet</h2>
